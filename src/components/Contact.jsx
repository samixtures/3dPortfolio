...
//templateID: template_ac6rrt7
//serviceID: service_2ad2goy
//publicKey: d_pcQ2e7j07aI0b4T
...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'service_2ad2goy', 'template_ac6rrt7', 
      {
        from_name: form.name,
        to_name: "Sami Bajwa",
        from_email: form.email,
        to_email: "bajwasami309@gmail.com",
    ...
    <div className='xl: mt-12 xl: flex-row flex-col-reverse flex gap-10 overflow-hidden'>
      ...
      >
        ...
        >
          ...
          <button
            type="submit"
            className='bg-tertiary py-3 px-8 outline-none w-white w-fit text-white font-bold shadow-md shadow-primary rounded-xl'
          >
